...
const app = new Vue({
  ...
  data: {
    ...
    show: {
      ...
      'dialog': {
        inputDocPasswordDialog: false, resetDocPasswordDialog: false, userPasswordDialog: false, copyDocDialog: false, setAclDialog: false,
        pasteContentDialog: false, MsgBox: false, shareDialog: false, materialDialog: false,
        rechargeDialog: false, priceListDialog: false
      },
    },
    model: {
      firstTime: true,
