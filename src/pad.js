...
const app = new Vue({
  ...
  data: {
    ...
    model: {
      ...
      signin: { userid: '', pwd: '' },
      docfields: [{ key: 'name', label: '文档名称' }, { key: 'owner', label: '发起人' }, { key: 'acl', label: '权限范围' }, { key: 'readonly_icon', label: '只读' }, { key: 'protect_icon', label: '密保' },  { key: 'operations', label: '其它', variant: 'danger' }],
